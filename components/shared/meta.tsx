...
const Meta = ({ title, keywords, description, image }: Props): JSX.Element => {
  return (
    <Head>
      ...
      <title>{title.includes('Yannick') ? title : title.concat(' | Yannick Aaron Lehr')}</title>
    </Head>
  );
};

Meta.defaultProps = {
  title: 'Yannick Aaron Lehr - Tech-Consultant',
  keywords: 'web development, programming, web design, react js, chakra ui',
  description: 'Yannick Aaron Lehr - Tech-Consultant',
  image: SEO_IMAGE
};
